...
import logingif from "../../assets/index";

import { LoginService, forgotPasswordLinkService } from "../../services/AuthService.js";
...
export default function Login() {
  ...
  return (
    <div className=" login-container">
      <Navbar  data={false} btnname={"SignUp | Register"} route={"/signup"}/>
